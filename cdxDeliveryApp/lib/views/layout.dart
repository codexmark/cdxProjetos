...
class Layout {
  ...
  // fiz desse layout aqui https://material.io/resources/color/#!/?view.left=0&view.right=1&primary.color=D32F2F&secondary.color=C2C03E&secondary.text.color=ffffff
  ...
  static Color secondary([double opacity = 1]) =>
      Colors.yellow[800].withOpacity(opacity);
  static Color secondaryLight([double opacity = 1]) =>
      Color(0xfff7f26f).withOpacity(opacity);
  static Color secondaryDark([double opacity = 1]) =>
      Color(0xff8f9000).withOpacity(opacity);
  ...
  static Color info([double opacity = 1]) =>
      Color.fromRGBO(13, 71, 161, opacity);
